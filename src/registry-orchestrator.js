...
function buildOrchestratorPrompt({
  ...
  if (conversational) {
    return [
      ...
      'Privacy: do not infer, use, or reveal the user\'s personal name from filesystem paths, account names, repository URLs, GitHub handles, environment variables, or local metadata. Address the user without a name unless they explicitly gave one in the chat.',
  ...
  return [
    ...
    'Privacy: filesystem paths and account metadata are operational context only. Do not infer, use, or reveal the user\'s personal name from paths, account names, repository URLs, GitHub handles, environment variables, or local metadata unless they explicitly gave that name in the chat.',
