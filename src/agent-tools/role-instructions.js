...
export const ROLE_INSTRUCTIONS = {
  orchestrator:
    ...
    + '(2) Use orchestrator.status for the canonical lane tree + next required tool ("what is happening") view of the lanes Orca manages. Poll it while you work — it keeps your ownership from going stale. It does NOT extend your tool lease: the lease expires at a fixed time, nothing renews it, and once it expires every call fails with "Tool lease has expired".\n'
