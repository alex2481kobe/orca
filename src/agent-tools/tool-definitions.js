...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    implemented: true,
    mutating: true,
    summary: 'Create a session in a project. Body: name (required), leader (executor type), approvedCapacity, spawnPolicy (never|ask|within_capacity|auto), repoRoot, defaultModel. Use spawnPolicy:"auto" to let the backlog fan out automatically.',
  },
  {
    id: 'session.list',
    group: 'session',
