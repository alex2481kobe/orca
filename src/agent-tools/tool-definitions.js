...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    implemented: true,
    mutating: false,
    summary: 'List the captured artifact files for a lane (screenshots, outcome/transcript, evidence). Use this to verify a lane produced the evidence its work requires.',
  },
  {
  ...
  },
  {
    ...
    implemented: true,
    mutating: false,
    summary: 'Read the durable audit-event history (what has happened: lane lifecycle, approvals, integrations, leases). Query: status (pending|passed|failed). This is the record an agent reviews to see what occurred.',
  },
  {
    id: 'audit.log.ack',
    group: 'audit',
    ...
    implemented: true,
    mutating: true,
    summary: 'Acknowledge one pending audit event (mark it reviewed). Body: {notes?}. Use after reviewing a pending item in the audit log.',
  },
  {
    id: 'project.list',
    group: 'projects',
