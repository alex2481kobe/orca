...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    implemented: true,
    mutating: false,
    summary: 'Read bounded agent working memory for compaction/reconnect. Supervisors, orchestrators, and dashboard can see session entries; lane-scoped roles see their own entry.',
  },
  {
    id: 'session.memory.update',
    group: 'session',
    roles: ['supervisor', 'orchestrator', 'executor', 'auditor', 'critique', 'dashboard'],
    method: 'PATCH',
    route: '/api/sessions/{sessionId}/agent-memory',
    implemented: true,
    mutating: true,
    summary: 'Update the caller-owned compact working-memory entry. Body fields: replace, ifMatch, statePhase, currentFocus, activeWork, decisions, blockers, nextActions, risks, futureImplementations, activeImplementationIds, openQuestions, handoffNotes. Use replace:false for incremental compact updates.',
  },
  {
    id: 'session.create',
    group: 'session',
  ...
  },
  {
    ...
    implemented: true,
    mutating: false,
    summary: 'List durable autonomous loops for a session, including state, cadence, iteration, executor mix, and progress counts.',
  },
  {
    id: 'loop.describe',
    group: 'loop',
    ...
    implemented: true,
    mutating: false,
    summary: 'Read one durable loop and its progress counters.',
  },
  {
    id: 'loop.create',
    group: 'loop',
