// The large delegated action handlers for lane / session / system data-action
// buttons (stop/retry/audit/critique/approve, executor + capacity + cleanup
// management, etc.). Invoked by the app.js event dispatcher. Extracted from app.js.
...
import { loadEvidenceGallery, refreshComposerAttachments } from './render-views.js';
import { shell } from './state.js';
import { buildApprovedActionBody } from './handlers.js';
